...
import { updateAvatar, updateUser } from "../../../redux/action/user";
  ...
  return (
    <div className="flex items-center  w-full flex-col md:mt-0 mt-[20%]">
        ...
        <div className="relative">
          {user ? (
            <img
              ...
              className="md:w-[150px] md:h-[150px] rounded-full w-[90px] h-[90px]"
            />
          ) : (
          ...
          <label
            htmlFor="upload"
            className="absolute bottom-1 right-3 bg-[#E3E9EE] rounded-full p-1 cursor-pointer"
          >
      ...
      >
        <Form
          value1={user && name}
          setValue1={user && setName}
          value2={user && email}
          setValue2={user && setEmail}
          label1="Full name"
          label2="email"
          type1="text"
          type2="email"
        ...
        <div className="w-full flex items-center justify-center py-4">
          <button
            type="submit"
            className={`${styles.button} !bg-blue-700 text-white hover:bg-blue-600`}
          >
            Update
          </button>
        </div>
