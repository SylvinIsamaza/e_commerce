...
import { deleteAddress, updateAddress } from "../../../redux/action/user";
    ...
    <>
      <div className="w-full py-3 px-5">
        <div className="flex items-center w-full justify-between">
          ...
          <div
            className={`${styles.button} text-white !rounded-md`}
      ...
      {open ? (
        <div className="w-[100vw] bg-[#0000001b] h-screen top-0 fixed left-0 flex justify-center items-center">
          <div className="800px:w-[35%] 600px:w-[50%] w-[90%] bg-white rounded-md shadow-sm h-[89vh] overflow-y-scroll ">
            ...
            <div className="w-full px-3 font-[500] font-Poppins text-[17px]">
              <form aria-aria-required onSubmit={handleSubmit}>
                <label
                  htmlFor="country"
                  className="mx-[5%]  text-[#000000ab] font-[600]"
                >
                  Country
                </label>
                <br />
                <select
                  name="country"
                  id="country"
                  className="w-[90%] h-[35px] rounded-md bg-transparent border border-gray-200 mx-[5%] my-2 "
                  value={country}
                  onChange={(e) => {
                ...
                >
                  ...
                  {City.getCitiesOfCountry(country).map((item) => (
                    <option value={item.isoCode} key={item}>
                      {item.name}
                    </option>
                  ))}
                </select>
                ...
                <input
                  ...
                  name="address1"
                  id="address1"
                  className="w-[90%] h-[35px] rounded-md bg-transparent border border-gray-200 mx-[5%] my-2 px-2"
                ...
                <input
                  ...
                  value={zipCode}
                  onChange={(e) => selectZipCode(e.target.value)}
                />
                <label
                  htmlFor="addressType"
                  className="mx-[5%] text-[#000000ab] font-[600]"
                ...
                >
                  ...
                  {addressTypeData.map((item) => (
                    <option value={item.name} key={item.name} className="pb-2 ">
                      {item.name}
                    </option>
                  ))}
                </select>
