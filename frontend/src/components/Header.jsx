...
function Header({activeHeading, user}) {
    ...
    const handleSearchChange = (e) => {
        ...
        setSearchTerm(term);
        const filteredProduct = productData.filter((product) => product.name.toLowerCase().includes(term.toLowerCase()))
    ...
    return (
        <> {/* // mobile header  */}
            <div className='top-0 w-full 800px:hidden sticky  z-30  flex items-center bg-white h-[50px] justify-between  '>
                ...
                <BiMenuAltLeft size={40} className='ml-4 cursor-pointer' onClick={()=>{
                    setOpen(true)
                ...
                <div className='mr-4'> 
                    <AiOutlineShoppingCart color='rgba(0,0,0,0.83)' className='cursor-pointer'
                        size={40} 
                    />
                    <span className='h-4 w-4 absolute bg-[#3bc177] rounded-full top-1 right-3 text-[12px] text-center p-0 text-[white] leading-relaxed'>1</span>
                </div>
            ...
            <div className={
                ...
                <div className={
                    `${
                        ...
                        styles.normalFlex
                    }  h-[60px] relative justify-between `
                }>
                    <div>
                    ...
                    <div className='flex'>
                        <div className={
                            `800px:${
                                styles.normalFlex
                            } relative mr-[15px] hidden`
                        }>

                            <AiOutlineHeart color='rgba(255,255,255,0.83)'
                                size={30}
                            ...
                            <span className='h-4 w-4 absolute bg-[#3bc177] rounded-full top-0 right-0 text-[12px] text-center p-0 text-[white] leading-relaxed'>0</span>
                        </div>
                        <div className={
                            `800px:${
                                styles.normalFlex
                            ...
                            <AiOutlineShoppingCart color='rgba(255,255,255,0.83)' className='cursor-pointer'
                                size={30}
                                onClick={
                                    () => {
                                        setOpenCart(true)
                            ...
                            <span className='h-4 w-4 absolute bg-[#3bc177] rounded-full top-0 right-0 text-[12px] text-center p-0 text-[white] leading-relaxed'>1</span>
                        </div>
                        {
                        ...
                        }><CgProfile color='rgba(255,255,255,0.83)'
                                size={30}/></Link>
                    } </div>
                </div>
        ...
        {
            open?<MobileHeader setOpen={setOpen} handleSearchChange={handleSearchChange} searchTerm={searchTerm} searchData={searchData} activeHeading={activeHeading} user={user}/>:''
        }
         </>
