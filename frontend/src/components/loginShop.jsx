...
import { loadSellerStart, loadSellerSuccess } from '../redux/reducer/shop';
function ShopLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post(`${server}/api/v2/shop/login`, {email, password},{withCredentials:true})
        .then(async (data) => {
            ...
            <div className=" mx-auto sm:w-full sm:max-w-md:">
                <div className='bg-white py-8 px-6 shadow rounded sm:rounded-lg'>
                    ...
                    <div className={
                        ...
                        <Link to="/shop-creation" className='text-blue-600 pl-2'>
                            Signup</Link>
                    </div>
                </form>
            </div>
